...
const INTERACTIVE_RANDOM_EVENTS = [
{
    ...
    choices: [
        { text: "Kabul Et", nextId: 'hub', step: 0, icon: '😮‍💨', effect: withMsg({ karizma: 10, saglik: -10 }, "Ortama ayak uydurup sempati topladın ama sağlığın zarar gördü.") },
        { text: "Reddet", nextId: 'hub', step: 0, icon: '🚭', effect: withMsg({ zeka: 10, karizma: -10 }, "Sağlığını önemseyip geri çevirdin ama arkadaşlarına alay konusu oldun.") }
    ]
	},
	{
    ...
    choices: [
        { text: "Cebinden Öde", nextId: 'hub', step: 0, icon: '💸', effect: withMsg({ mutluluk: 45, para: -400 }, "Birikmiş paranla ödeme yaptın. Biraz para harcadın ama arkadaşlarınla çok eğlendiniz.") },
        ...
        },
        {
            ...
            {
                id: 'rnd_turk_kahvesi', minAge: 18, maxAge: 99,
                emoji: '☕', title: "Türk Kahvesi Falı",
                description: "Komşun güzel bir Türk kahvesi faldı ve senin falına bakmak istedi. Kahve koje eli okunabilir mi?",
                choices: [
                    { text: "Falına Bak", nextId: 'hub', step: 0, icon: '👁️', effect: withMsg({ sans: 5, mutluluk: 10 }, ["Falcı güzel haberler verdi: 'Yakında sıpır sıpır dinheiro geliyor!'", "Falcı biraz hayal kurdu ama genel olarak pozitif bir gün önceden gördü."]) },
                    { text: "İnkar Et", nextId: 'hub', step: 0, icon: '🙅‍♂️', effect: withMsg({ zeka: 5 }, "Falculara güvenmediğin için sadece kahvesini içip sohbete devam ettin.") }
                ]
            },
            {
                id: 'rnd_belediye_firin', minAge: 0, maxAge: 99,
                emoji: '🍞', title: "Belediye Fırını",
                description": "Belediye fırını bugün özel bir ekmek pişırmiş ve ücretsiz dağıtıyor. Kuyruk çok uzun ama değmiş gibi görünüyor.",
                choices: [
                    { text: "Kuyruğa Gir", nextId: 'hub', step: 0, icon: '👥', effect: withMsg({ mutluluk: 15, enerji: -10 }, ["Sıcak ekmeni aldın ve keyifle yedin.", "Ekmek çok lezzetliydi ve gününü güzel bir başlangıç için hazırlıklı hissettin."]) },
                    { text: "Devam Et", nextId: 'hub', step: 0, icon: '➡️', effect: withMsg({ mutluluk: -5 }, "Kuyruğu gördüğün için gitmeye karar verdin, bugün normal ekmek alacaksın.") }
                ]
            },
            {
                id: 'rnd_ogrenci_kredisi', minAge: 18, maxAge: 25,
                emoji: '📚', title: "Öğrenci Kredisi Başvurusu",
                description": "Üniversiteden mezun olup iş bulmakta zorlandığın için devlet tarafından verilen düşük faizli öğrenci kredisi başvurusu yaptığın ilan çıktı.",
                choices: [
                    { text: "Başvur Yap", nextId: 'hub', step: 0, icon: '📝', effect: withMsg({ para: 5000, okul: 5, mutluluk: -5 }, ["Kredi onaylandı ve hesabına yatırıldı. Şimdi bir iş arayabilir veya daha fazla eğitim alabilirsin.", "Kredi onaylandı! Artık kendi işini başlatmak için sermaye biriktirmeye başlayabilirsin."]) },
                    { text: "Başvurma", nextId: 'hub', step: 0, icon: '🚫', effect: withMsg({ zeka: 5 }, "Kredi borç olduğundan düşündüğün için başvurmaya karar verdin, kendini daha çok zorlamaya karar verdin.") }
                ]
            },
            {
