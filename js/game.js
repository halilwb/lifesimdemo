...
// ===================================================
        ...
        const StatHeader = ({ icon, value, type, suffix = "", colorClass }) => {
            ...
            return (
                <div className="flex flex-col items-center relative bg-white/70 backdrop-blur-md border-white/60 text-slate-700">
                ...
                return (
                    <div className="app-container">
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center p-6 z-10 w-full">
                            ...
                            <h1 className="text-3xl font-black text-center text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-600 mb-6">
